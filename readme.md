...
| [LittleFS filesystem using SD Card media](apps/fs/sdspi_littlefs/readme.md) | This application shows an example of using the MPLAB Harmony File System to access and modify the contents of a SD card using the SDSPI driver and the SPI PLIB |
